...
//+kubebuilder:webhook:path=/mutate-samplecontroller-littlewat-github-io-v1alpha1-foo,mutating=true,failurePolicy=fail,sideEffects=None,groups=samplecontroller.littlewat.github.io,resources=foos,verbs=create;update,versions=v1alpha1,name=mfoo.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-samplecontroller-littlewat-github-io-v1alpha1-foo,mutating=false,failurePolicy=fail,sideEffects=None,groups=samplecontroller.littlewat.github.io,resources=foos,verbs=create;update,versions=v1alpha1,name=vfoo.kb.io,admissionReviewVersions=v1

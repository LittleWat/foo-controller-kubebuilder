...
import (
	...
	samplecontrollerv1beta1 "github.com/LittleWat/foo-controller-kubebuilder.git/api/v1beta1"
	"github.com/LittleWat/foo-controller-kubebuilder.git/controllers"
...
func main() {
	...
	var rsyncPeriod = time.Second * 30

	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		SyncPeriod:             &rsyncPeriod,
		Scheme:                 scheme,
		MetricsBindAddress:     metricsAddr,
		Port:                   9443,
		HealthProbeBindAddress: probeAddr,
		LeaderElection:         enableLeaderElection,
		LeaderElectionID:       "8471c95f.littlewat.github.io",
